...
const ReactionDistanceCalculator: FC = () => {
  ...
  const calculateBrakingDistance = (kmPerHour: number): string => {
    ...
    const reactionDistance = ((kmPerHour / 10) * 3).toFixed(2);
    return `${reactionDistance} meter`;
  };
...
export default ReactionDistanceCalculator;
